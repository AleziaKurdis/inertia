...
(function(){
    ...
    var tpSound;
    var TP_SOUND = ROOT + "../sounds/hyperspace.mp3";
    ...
    function hyperspace(destination) {
        ...
        if (positionIsInsideEntityBounds(thisEntityID, MyAvatar.position)) {
            ...
            var arrivalRotation = Quat.multiply(destinations[destination].rotation, Quat.multiply( MyAvatar.rotation, entityRotation ));
