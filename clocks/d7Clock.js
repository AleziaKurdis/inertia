...
//
//  D7 (Dilatation 7 Hours Time) library.
//
...
(function(){ 
    ...
    var UNIT = D7Lib.getOfficialUnit();
    ...
    function updateClock() {
        ...
        //color value
        var HUE_DAY_DURATION = D7Lib.getDayLenghtInSec();
        var HUE_WEEK_DURATION = HUE_DAY_DURATION * 9;
        var hue = D7Lib.GetCurrentCycleValue(1, HUE_WEEK_DURATION);
        var color = hslToRgb(hue, 1, 0.5);
        //=======================================
        var textOfficialColor = D7Lib.getOfficialColor();
        ...
        if (clockID === Uuid.NULL){
            ...
            hourID = Entities.addEntity({
                ...
                "text": D7Lib.getClockText(0, true, false),
                "renderWithZones": thisRenderWithZones,
            ...
            dateID = Entities.addEntity({
                ...
                "text": D7Lib.getClockText(4, true, false),
                "renderWithZones": thisRenderWithZones,
            ...
            dayID = Entities.addEntity({
                ...
                "text": D7Lib.getClockText(7, true, false),
                "renderWithZones": thisRenderWithZones,
