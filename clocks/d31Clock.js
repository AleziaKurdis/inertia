...
//  d31Clock.js
//
//  Created by Alezia Kurdis on February 20th, 2026.
//  Copyright 2026 Alezia Kurdis.
//
//  D31 (Dilatation 31 Hours Time) library.
//
//  Distributed under the Apache License, Version 2.0.
//  See the accompanying file LICENSE or http://www.apache.org/licenses/LICENSE-2.0.html
//
(function(){ 
    var jsMainFileName = "d31Clock.js";
    var ROOT = Script.resolvePath('').split(jsMainFileName)[0];
    var D31Lib = Script.require(ROOT + "d31_library.js");
    
    var UPDATE_TIMER_INTERVAL = (D31Lib.getDayLenghtInSec()/(24 * 60)) * 1000;
    var processTimer = 0;
    var thisID;
    var thisPosition;
    ...
    var UNIT = D31Lib.getOfficialUnit();
    ...
    function updateClock() {
        ...
        //color value
        var HUE_DAY_DURATION = D31Lib.getDayLenghtInSec();
        var HUE_WEEK_DURATION = HUE_DAY_DURATION * 9;
        var hue = D31Lib.GetCurrentCycleValue(1, HUE_WEEK_DURATION);
        var color = hslToRgb(hue, 1, 0.5);
        //=======================================
        var textOfficialColor = D31Lib.getOfficialColor();
        ...
        if (clockID === Uuid.NONE){
            ...
            hourID = Entities.addEntity({
                ...
                "text": D31Lib.getClockText(0, true, false),
                "renderWithZones": thisRenderWithZones,
            ...
            dateID = Entities.addEntity({
                ...
                "text": D31Lib.getClockText(4, true, false),
                "renderWithZones": thisRenderWithZones,
            ...
            dayID = Entities.addEntity({
                ...
                "text": D31Lib.getClockText(7, true, false),
                "renderWithZones": thisRenderWithZones,
