//Light flicker by Alezia Kurdis - December 2018
...
(function(){
	...
	function Update(Myentity){
			var newval = (Math.random() * 0.4)  + 0.8;
			
			var colo = hslToRgb(GetCurrentCycleValue(1, 900), 1, 0.5);
			
			Entities.editEntity(Myentity, {"intensity": newval, "color": {"red": colo[0], "green": colo[1], "blue": colo[2] }});
