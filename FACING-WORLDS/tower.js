...
(function(){
    ...
    this.preload = function(entityID) {
        ...
        id = Entities.addEntity({
            ...
            "shape": "Cube",
            "script": ROOT + "localTeleporter.js",
            "description": '{"team": "' + team + '", "teamColor": ' + JSON.stringify(lightColor) + ', "localPosition": { "x": -1.0366, "y": -34.6711, "z": -7.9187}, "localRotation": ' + JSON.stringify(Quat.fromVec3Degrees( { "x": 0, "y": -90, "z": 0} ))+ '}'
        }, "local");
        entitiesToDelete.push(id);
