//#####################
//
//  navigationAmbienceTronix.js
//
//  Created by Alezia Kurdis, January 2nd, 2026.
//  Copyright 2026, Overte e.V.
//
//  Sky anbience and navigation for Tronix scenery.
//
//  Distributed under the Apache License, Version 2.0.
//  See the accompanying file LICENSE or http://www.apache.org/licenses/LICENSE-2.0.html
//
(function(){
    var ROOT = Script.resolvePath('').split("navigationAmbienceTronix.js")[0];
...
/*
            for (let i=0; i < asteroidStack.length; i++) {
    ...
    function updateNavigation() {
        if (isInitiated){
            ...
            if ( d29CurrentHour > 2 && d29CurrentHour < 8 ) {
                if (storming) {
