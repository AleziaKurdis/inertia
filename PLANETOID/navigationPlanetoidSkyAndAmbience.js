...
(function(){
    ...
    function generateLanterns() {
        var lanterns = [
            ...
            {"position": {"x":4058.90087890625,"y":4362.65576171875,"z":3653.8828125}, "gravity": "INNER"},
            {"position": {"x":4052.239501953125,"y":4331.53564453125,"z":3639.322998046875}, "gravity": "INNER"},
            {"position": {"x":4044.629638671875,"y":4300.67626953125,"z":3632.910888671875}, "gravity": "INNER"}
        ];
        var modelUrl = "";
        var lightColor;
        ...
        for (var i = 0; i < lanterns.length; i++) {
            ...
            lanternID = Entities.addEntity({
                ...
                "modelURL": modelUrl,
                "parentID": thisEntity,
                "localPosition": lanternLocalPosition,
