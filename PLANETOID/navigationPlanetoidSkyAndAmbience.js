...
*/
        ...
        var zoneRotation = Quat.fromVec3Degrees( {"x": 90.0, "y": 0.0, "z": GetCurrentCycleValue(360, 3600)} ); //3600 s = 60 minute Days long. so 0.1 deg/s
        ...
        if (zoneID === Uuid.NULL) {
            zoneID = Entities.addEntity({
                ...
                "localAngularVelocity": {"x": 0, "y": 0.0, "z": 0.00174533},
                "angularDamping": 0.0,
                "grab": {
                    "grabbable": false
                },
